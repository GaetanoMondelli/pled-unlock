  ...
  useEffect(() => {
    ...
    const setupAnimation = async () => {
      ...
      const ctx = gsap.context(() => {
        ...
        gsap.set(
          ["#node-a .core", "#node-b .core", "#node-c .core", "#node-d .core", "#node-e .core", "#node-f .core"],
          {
            fill: "#ffffff",
          },
        );
        ...
        <g id="stage">
          ...
          <g id="notif-annot" transform="translate(520, 130)" opacity="0">
            <g transform="translate(0, 0)">
              ...
              <text x="30" y="14" className="text-[10px]" fill="#ffffff">
                Send notification
              </text>
            </g>
          </g>
          ...
          <g id="token-annot" transform="translate(620, 420)" opacity="0">
            <g transform="translate(0, 0)">
              ...
              <text x="28" y="14" className="text-[10px]" fill="#ffffff">
                Emit token
              </text>
            </g>
          </g>
