      ...
      <div className="px-3 py-2 border-b border-slate-100">
        ...
        <div className="grid grid-cols-2 gap-2 text-xs">
          <div className="flex justify-between">
            ...
            <Badge variant="outline" className="text-xs">{totalRoutes}</Badge>
          </div>
          <div className="flex justify-between">
            <span className="text-slate-500">Active:</span>
            <Badge
              variant={activeRoutes > 0 ? "default" : "outline"}
              className={cn("text-xs", activeRoutes > 0 && "bg-green-100 text-green-800")}
            >
              {activeRoutes}
            </Badge>
          </div>
        ...
        <div className="mt-2 p-2 bg-slate-50 rounded text-xs">
          <div className="font-mono text-slate-700">Test State: {testStateContext.currentState}</div>
          <div className="text-slate-500">Context: {JSON.stringify(testStateContext.context)}</div>
        </div>
      </div>
      ...
      <div className="px-3 py-2 bg-slate-50">
        <div className="grid grid-cols-2 gap-2 text-xs">
          ...
          <div className="flex justify-between">
            ...
            <span className="font-mono text-slate-700">{outputs.length}</span>
          </div>
          <div className="flex justify-between">
            <span className="text-slate-500">Routes:</span>
            <span className="font-mono text-slate-700">{totalRoutes}</span>
          </div>
          <div className="flex justify-between">
            <span className="text-slate-500">Matched:</span>
            <span className="font-mono text-slate-700">{activeRoutes}</span>
          </div>
        </div>
      </div>
