    ...
    <div className="min-h-[calc(100vh-80px)]">
          ...
          <div className="grid lg:grid-cols-2 gap-6 lg:gap-10 items-stretch">
            ...
            >
              ...
              <motion.p
                ...
                variants={fadeUp}
              >
                Pled creates verifiable,{" "}
                <span className="font-semibold text-foreground">
                  living digital twins
                </span>{" "}
                of your most complex processes, from contracts to supply chains,
                bridging the gap between tokens and reality
              </motion.p>
              <motion.div
                id="hero-cta"
              ...
              >
                <RequestDemoDialog
                  trigger={<Button size="lg">Book a Demo</Button>}
                />
        ...
        <div className="container mx-auto px-6 py-20">
          <BlurFade delay={0.1} className="text-center mb-12">
            <h2 className="text-2xl sm:text-3xl font-bold">
              Model Complex Workflows with AI Assistance
            </h2>
            <p className="mt-4 max-w-3xl mx-auto text-muted-foreground">
              Our visual template editor lets you design tokenization workflows
              using AI chat, just like Cursor for digital transformation
            </p>
          </BlurFade>
                ...
                <div className="bg-white dark:bg-gray-900 rounded-lg overflow-hidden shadow-lg">
                  <video
                    ...
                    onError={(e) => {
                      ...
                      img.alt =
                        "Pled Template Editor showing AI-powered workflow simulation with queue processing, data sources, and AI assistant";
      ...
      <section className="border-t bg-white dark:bg-black">
        <div className="container mx-auto px-6 py-20">
          <BlurFade delay={0.2} className="mb-16">
            <h2 className="text-2xl sm:text-3xl font-bold">
              Today's Tokenization is Broken.
            </h2>
            <p className="mt-4 max-w-3xl text-muted-foreground">
              Tokenization promises to transform global markets and unlock
              trillions in value. Yet today's tokens are static, outdated, and
              costly to maintain, undermining trust and scalability
            </p>
          </BlurFade>
              ...
              <BentoGridItem
                ...
                description={
                  <div className="space-y-3 text-base">
                    ...
                    <div>
                      • Legacy systems can't handle well unstructured data
                    </div>
                    <div>
                      • Existing solutions and smart contracts are too rigid
                    </div>
                    <div>• Unclear regulations create uncertainty</div>
                    <div>
                      • Low liquidity and fragmented protocols limit adoption
                    </div>
                  </div>
                }
                header={
            ...
            >
              <BentoGridItem
                ...
                description={
                  <div className="space-y-3 text-base">
                    <div>
                      • AI interprets unstructured data with reliability scoring
                    </div>
                    <div>• Smart state machines handle complex workflows</div>
                    <div>
                      • Modular architecture for flexible agreement modeling
                    </div>
                    <div>
                      • Data storage, processing and settlement are separated
                    </div>
              ...
              <BentoGridItem
                ...
                description={
                  <div className="space-y-3 text-base">
                    ...
                    <div>
                      • Lower investment barriers for broader market access
                    </div>
      ...
      <section className="border-t bg-muted/30">
        <div className="container mx-auto px-6 py-16">
          <BlurFade delay={0.1}>
            <h2 className="text-2xl sm:text-3xl font-bold">
              Pled turns digital mess into living digital twins
            </h2>
            <p className="mt-3 max-w-3xl text-muted-foreground">
              Turn messy, real-world signals into reliable insights, then
              automate decisions with guardrails. From ingestion to action,
              every step is observable, testable, and safe by design
            </p>
          </BlurFade>
      ...
      <section className="border-t bg-white dark:bg-black">
        <div className="container mx-auto px-6 py-20">
          <BlurFade delay={0.2}>
            <h2 className="text-2xl sm:text-3xl font-bold">
              AI-Powered Verifiable Operations
            </h2>
            <p className="mt-3 max-w-3xl text-muted-foreground">
              Turn messy, real-world processes into auditable, automated
              workflows.
            </p>
          </BlurFade>
          <div className="mt-10 grid gap-10 sm:grid-cols-2 lg:grid-cols-3">
            <div>
              ...
              <p className="mt-2 text-muted-foreground">
                Model any process as a state machine. Enforce transitions with
                strict logic so your workflows behave exactly as designed.
              </p>
            </div>
            <div>
              <div className="p-2 rounded-md bg-primary/10 text-primary w-fit mb-3">
              ...
              <p className="mt-2 text-muted-foreground">
                Emails, PDFs, IoT signals, contracts — our AI interprets
                ambiguous events, validates them, and assigns a Reliability
                Index (RI) to manage uncertainty.
              </p>
            </div>
            <div>
              <div className="p-2 rounded-md bg-primary/10 text-primary w-fit mb-3">
              ...
              <p className="mt-2 text-muted-foreground">
                Every validated state change triggers the next step
                automatically — sending alerts, generating docs, approving
                payments, or syncing with external systems.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="border-t bg-gradient-to-b from-white to-slate-50 dark:from-gray-950 dark:to-black">
        <div className="container mx-auto px-6 py-20">
          <BlurFade delay={0.3}>
            <h2 className="text-2xl sm:text-3xl font-bold">
              Pled is the AI that makes tokenization trustworthy.
            </h2>
            <p className="mt-3 max-w-2xl text-muted-foreground">
              Ready to bridge reality and digital assets?
            </p>
