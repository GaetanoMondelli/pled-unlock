...
export async function POST(request: Request) {
  try {
    ...
    const activateResponse = await fetch(`https://demo.docusign.net/clickapi/v1/accounts/${accountId}/clickwraps/${clickwrap.clickwrapId}/versions/${clickwrap.versionId}`, {
      method: 'PUT',
      headers: {
        'Authorization': `Bearer ${authHeader}`,
        'Content-Type': 'application/json'
    ...
    const urlResponse = await fetch(`https://demo.docusign.net/clickapi/v1/accounts/${accountId}/clickwraps/${clickwrap.clickwrapId}/agreements`, {
      method: 'POST',
      headers: {
        'Authorization': `Bearer ${authHeader}`,
        'Content-Type': 'application/json'
